      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <span className={isMockMode ? "text-cyan-600 dark:text-cyan-400" : "text-gray-500"}>Mock Mode</span>
            <Switch
              checked={isMockMode}
            ...
            />
            <span className={!isMockMode ? "text-cyan-600 dark:text-cyan-400" : "text-gray-500"}>Real Mode</span>
          </div>
